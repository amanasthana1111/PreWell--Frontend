  ...
  return (
    <div className="bg-[#0b1431] w-full py-20 px-4 text-white">
      ...
      <div className="max-w-6xl mx-auto bg-[#1e2a48] rounded-2xl p-6 md:p-10 flex flex-col md:flex-row items-center gap-8 shadow-lg">
        {/* Image */}
        <img
          src="https://avatars.githubusercontent.com/u/183270144?v=4" // replace with your own image
        ...
        <div className=" flex-1 relative">
          <h4 className="text-2xl text-gray-400 mb-1">Akarsh Yadav</h4>
         ...
         <p className="mb-8 text-gray-300 text-sm leading-relaxed max-w-182.5">
            Akarsh Yadav is a passionate full-stack developer and product
            ...
            more. Akarsh Yadav blends design thinking with technical skills, building
          ...
          {/* LinkedIn Icon */}
          <a
            href="https://www.linkedin.com/in/akarsh-yadav-499b97247/" 
            target="_blank"
          ...
          <a
            href="https://github.com/AkarshYadav9411" 
            target="_blank"
            rel="noopener noreferrer"
